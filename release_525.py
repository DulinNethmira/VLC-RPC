...
def main():
    ...
    release_title = "✨ v5.2.5 - Hotfix: The Ultimate Rewatch Update! 🔄"
    release_notes = """### 🚀 What's New in v5.2.5!
...
Enjoy the update! 🎉"""
    ...
    try:
        ...
        # Inno Setup output is usually VLC RPC Setup v5.2.5 Hotfix.exe in dist folder
        file_path = rf"dist\VLC RPC Setup v5.2.5 Hotfix.exe"
