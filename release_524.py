...
def main():
    ...
    if not token:
        # We cannot fallback to hardcoded token
        pass
    if not token:
    ...
    release_title = "✨ v5.2.4 - The Ultimate Rewatch Update! 🔄"
    release_notes = """### 🚀 What's New in v5.2.4!
...
Enjoy the update! 🎉"""
    ...
    try:
        ...
        # Inno Setup output is usually VLC RPC Setup v5.2.4 Hotfix.exe in dist folder
        file_path = rf"dist\VLC RPC Setup v5.2.4 Hotfix.exe"
