...
name = f"✨ v5.9.3 - Feature Length Films & Specials Formatting!"
body = """### 🚀 What's New in v5.9.3!

#### 🔧 Fixes & Tweaks
- **Anime Movie / Special Formatting Fix**: Fixed an aesthetic issue where Anime Movies or Specials (ones without episodes) would show a strange, floating empty separator (`| ⭐ 7.1`) below the title in Discord.
- Now, when watching feature-length content or one-off specials, the Discord Activity will automatically display the Anime's Genre tags (e.g. `Action, Comedy, Fantasy`) instead of leaving the space blank!
