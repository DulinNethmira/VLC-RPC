...
name = f"✨ v5.9.2 - Formatting Tweaks: The Return of Watching!"
body = """### 🚀 What's New in v5.9.2!

#### 🔧 Fixes & Tweaks
- **Activity Type Rollback**: We've reverted the Discord activity status back to `Watching` (for Anime/Movies) and `Listening` (for Music)! We heard you loud and clear, and we agree the `Watching` status looks way better than the generic `Playing` status on your profile.
